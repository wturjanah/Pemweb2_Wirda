...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Tugas Pemweb</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">VidyaFebriyana</a>
        </div>
      </div>
...
<h1 align='center' style="background-color: blue;color: white;"><b>INDEX HASIL</b></b></h1>
<table class="table table-hover">
  <thead>
    <tr>
